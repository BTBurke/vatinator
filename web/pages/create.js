...
export default function Login() {
    ...
    const handleSubmit = async () => {
        ...
        await client().post('/create', {email: email.value, password: password.value})
        .then((response) => {
            ...
            <div className="flex flex-col justify-center content-center items-center h-screen w-full">
                ...
                <div className="xs:w-75 md:w-50 xs:max-w-75 md:max-w-50 pb-16">
                    ...
                    <div className="p-4 bg-secondary rounded-md"> 
                        ...
                        <div className="pt-6">
                            <button disabled={loading} onClick={handleSubmit} className="w-full bg-accent-2 p-2 rounded-full text-white font-bold">{loading ? "Creating account..." : "Create account"}</button>
                        </div>
